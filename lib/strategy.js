...
var OAuth = {};
extend(true, OAuth, require('oauth'));
...
function EloquaStrategy(options, verify) {
  ...
  this._oauth2 = new OAuth.OAuth2(this._clientId,  this._clientSecret, '', this._authorizationURL, this._tokenURL, this._customHeaders);
